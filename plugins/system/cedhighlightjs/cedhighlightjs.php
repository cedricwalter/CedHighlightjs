...
class plgSystemCedHighlightJs extends JPlugin
{
	...
	public function onBeforeRender()
	{
		...
		$mode = intval($this->paramss->get('mode', 0));
		...
		if ($mode == 2)
		{
			$document->addScriptDeclaration("addEventListener('load', function() {
				var code = document.querySelector('#code');
				var worker = new Worker('media/plg_system_highlight/worker.js');
